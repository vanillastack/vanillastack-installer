...
router.post('/', function (req, res) {
  ...
  const extraVars = {
    ...
    repo: {
      registry: 'repo-new.vanillastack.cloudical.net' // adapted to static due to missing knowledge, where it is read from (cluster.registry_endpoint), // todo: needs to be clarified
    },
